...
| --- | --- | --- |
| Preguntas evaluadas / 20 | 20.0000 | 20.0000 |
| Acierto global | 0.5500 | 0.9500 * |
| Acierto numéricas | 0.8571 | 1.0000 * |
| Acierto extractivas | 0.7143 | 1.0000 * |
| Acierto comparativas | 0.0000 | 0.8333 * |
| Recall de la trayectoria | 0.7692 | 0.8846 * |
| Coste medio agente (USD) | 0.0145 | 0.0144 * |
| Preguntas con coste conocido | 20.0000 | 20.0000 |
| Latencia media (s) | 24.2622 * | 30.5524 |
| Llamadas a herramientas | 3.7500 | 3.0000 * |
...
La variación del acierto global del sistema final es +40.0 puntos porcentuales. Las mejoras de búsqueda no garantizan el acierto final: también influyen el enrutamiento, la respuesta estructurada y la evidencia citada.
...
Coste registrado del juez: 0.003760 USD en 13 preguntas con coste de juez informado.

Ejemplo propio-015: ¿A cuánto ascendieron los ingresos totales de NVIDIA en FY2025? Compáralos con FY2024, indicando el importe de ambos ejercicios y la variación absoluta y porcentual. Compara también lo que sus informes de ambos ejercicios dicen sobre la demanda de centros de datos y el crecimiento ligado a IA.

Respuesta (extracto): Los ingresos totales de NVIDIA en FY2025 ascendieron a 130497000000 USD, frente a los 60922000000 USD de FY2024. Esto representa una variación absoluta de 69575000000 USD y un incremento porcentual del 114.20%.

En cuanto a la demanda de Data Center y el crecimiento impulsado por la IA:
- En FY2024, la compañía destacó un fuerte aumento en la demanda de infraestructura de IA por parte de aplicaciones de software empresarial e internet de consumo, impulsando los ingresos de computación de Data Center un 266% gracias a mayores envíos de la plataforma Hopper para entrenamiento e inferencia de modelos de lenguaje grande (LLMs) e IA generativa.
- En FY2025, el crecimiento continuó impulsado por p…

Criterios: cifra=True; cita=False; trayectoria=True; acierto=False

Motivo del juez de citas: Las citas cubren parcialmente el tema de IA y centros de datos para ambos años, pero la cita de 2025 es muy genérica y no detalla los motores de demanda como se afirma en la respuesta.
...
Fuentes locales: resultados\s2\comparacion\20260921T230019Z_c0888bbc ; resultados\s2\retrieval\20260921T215557Z_b69136ba
